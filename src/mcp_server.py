...
class SynologyMCPServer:
    ...
    def _create_server(self) -> Server:
        ...
        async def on_list_tools(
            ctx: object, params: PaginatedRequestParams | None
        ) -> ListToolsResult:
        ...
        async def on_call_tool(
            ...
            tools_result = await self.handle_call_tool(params.name, params.arguments or {})
            return CallToolResult(content=tools_result)
    ...
    def _setup_handlers(self):
        ...
        In mcp 2.0, handlers are registered via constructor callbacks
        in _create_server() rather than decorators. This method exists
        for any additional setup that may be needed.
        """
        pass

    async def handle_call_tool(self, name: str, arguments: dict) -> list[types.TextContent]:
        """Handle tool calls (used by both MCP 2.0 callback and bridge)."""
        try:
